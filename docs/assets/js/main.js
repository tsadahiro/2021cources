...
var $author$project$Main$subscriptions = function (model) {
	return model.shuffling ? A2($elm$time$Time$every, 50, $author$project$Main$Tick) : $elm$core$Platform$Sub$none;
};
...
var $author$project$Main$SetConf = function (a) {
	return {$: 'SetConf', a: a};
};
...
var $author$project$Main$swap = F2(
	function (model, i) {
...
var $author$project$Main$listSwap = F2(
	function (model, list) {
		return (!$elm$core$List$length(list)) ? model : A2(
			$author$project$Main$listSwap,
			A2(
	...
	function (msg, model) {
		switch (msg.$) {
			case 'Swap':
				var i = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$swap, model, i),
					$elm$core$Platform$Cmd$none);
			case 'Shuffle':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'SetConf':
				var list = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$listSwap, model, list),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$pieces = function (values) {
	return A2($elm$core$List$indexedMap, $author$project$Main$piece, values);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Svg$Styled$Events$onClick($author$project$Main$Shuffle),
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		view: A2($elm$core$Basics$composeR, $author$project$Main$view, $rtfeldman$elm_css$Svg$Styled$toUnstyled)
	});
