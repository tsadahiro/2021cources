...
var $author$project$Svgtest$Model = F3(
	function (zero, conf, shuffling) {
		return {conf: conf, shuffling: shuffling, zero: zero};
	});
...
var $author$project$Svgtest$init = function (_v0) {
	return _Utils_Tuple2(
		A3(
			$author$project$Svgtest$Model,
			0,
...
var $author$project$Svgtest$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$Svgtest$subscriptions = function (model) {
	return model.shuffling ? A2($elm$time$Time$every, 50, $author$project$Svgtest$Tick) : $elm$core$Platform$Sub$none;
};
...
var $author$project$Svgtest$SetConf = function (a) {
	return {$: 'SetConf', a: a};
};
...
var $author$project$Svgtest$swap = F2(
	function (model, i) {
		var yz = (model.zero / 3) | 0;
		var y = (i / 3) | 0;
		var xz = model.zero % 3;
		var x = i % 3;
		var value = A2(
			...
			A2(
				$elm$core$Maybe$withDefault,
				0,
				A2($elm$core$Array$get, i, model.conf)));
		var delta = $elm$core$Basics$abs(x - xz) + $elm$core$Basics$abs(y - yz);
		return (delta === 1) ? _Utils_update(
			model,
			{
				conf: A3(
					$elm$core$Array$set,
					model.zero,
					value,
					A3($elm$core$Array$set, i, 0, model.conf)),
				zero: i
			}) : model;
	});
var $author$project$Svgtest$listSwap = F2(
	function (model, list) {
		return (!$elm$core$List$length(list)) ? model : A2(
			$author$project$Svgtest$listSwap,
			A2(
				$author$project$Svgtest$swap,
				model,
				A2(
					$elm$core$Maybe$withDefault,
					0,
...
var $author$project$Svgtest$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Swap':
				var i = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Svgtest$swap, model, i),
					$elm$core$Platform$Cmd$none);
			case 'Shuffle':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{shuffling: !model.shuffling}),
					$elm$core$Platform$Cmd$none);
			case 'Tick':
				return _Utils_Tuple2(
					model,
					A2(
						$elm$random$Random$generate,
						$author$project$Svgtest$SetConf,
						A2(
			...
			case 'SetConf':
				var list = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Svgtest$listSwap, model, list),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Svgtest$Shuffle = {$: 'Shuffle'};
...
var $author$project$Svgtest$Swap = function (a) {
	return {$: 'Swap', a: a};
};
...
var $rtfeldman$elm_css$Svg$Styled$Attributes$strokeOpacity = $rtfeldman$elm_css$VirtualDom$Styled$attribute('stroke-opacity');
...
var $author$project$Svgtest$piece = F2(
	function (i, v) {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt((i % 3) * 100)),
							$rtfeldman$elm_css$Svg$Styled$Attributes$y(
							$elm$core$String$fromInt(((i / 3) | 0) * 100)),
							...
							$rtfeldman$elm_css$Svg$Styled$Attributes$ry('15'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$fill(
							(!v) ? 'white' : 'blue'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$fillOpacity(
							(!v) ? '0' : '0.5'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$stroke(
							(!v) ? 'white' : 'blue'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$strokeOpacity(
							(!v) ? '0' : '1')
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$Attributes$x(
							$elm$core$String$fromInt(((i % 3) * 100) + 50)),
							$rtfeldman$elm_css$Svg$Styled$Attributes$y(
							$elm$core$String$fromInt((((i / 3) | 0) * 100) + 50)),
...
var $author$project$Svgtest$pieces = function (values) {
	return A2($elm$core$List$indexedMap, $author$project$Svgtest$piece, values);
};
...
var $author$project$Svgtest$view = function (model) {
	return A2(
		$rtfeldman$elm_css$Svg$Styled$svg,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Svg$Styled$Attributes$width('400'),
				$rtfeldman$elm_css$Svg$Styled$Attributes$height('400')
			]),
		A2(
			$elm$core$List$append,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$Attributes$x('350'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$y('350'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$fill('white'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$stroke('black'),
							$rtfeldman$elm_css$Svg$Styled$Events$onClick($author$project$Svgtest$Shuffle),
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$text(
							model.shuffling ? 'stop' : 'shuffle')
						]))
				]),
			$author$project$Svgtest$pieces(
				$elm$core$Array$toList(model.conf))));
};
var $author$project$Svgtest$main = $elm$browser$Browser$element(
	{
		init: $author$project$Svgtest$init,
		subscriptions: $author$project$Svgtest$subscriptions,
		update: $author$project$Svgtest$update,
		view: A2($elm$core$Basics$composeR, $author$project$Svgtest$view, $rtfeldman$elm_css$Svg$Styled$toUnstyled)
	});
_Platform_export({'Svgtest':{'init':$author$project$Svgtest$main(
